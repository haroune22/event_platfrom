...
const Communities = () => {
  ...
  return (
    <>
      <div className="space-y-12 pb-10">
        <section className="overflow-hidden rounded-3xl bg-[url('/communities.png')] bg-cover bg-right bg-no-repeat">
          <div className="flex h-90 w-[70%] flex-col justify-center gap-6 px-10 lg:px-16">
            ...
            <p className="max-w-lg text-lg leading-8 text-gray-700">
              Discover communities that match your interests, attend events,
              learn new skills and meet people who share the same passion.
            </p>

            <Button
              onClick={() => setOpen(true)}
              className="w-fit rounded-xl bg-gray-900 px-7 py-6 text-base text-white hover:bg-gray-800"
            >
        ...
        <section className="space-y-5">
          ...
          {userCommunities.length > 0 ? (
            ...
            <div className="flex h-40 items-center justify-center rounded-2xl border border-dashed text-xl font-normal text-gray-700">
      ...
      <CreateCommunityDialog onOpenChange={setOpen} openDialog={open} />
    </>
  )
}
